...
label2=Label(root, text="ENTER ITEM PRICE",bd="2",relief="ridge",height="1",bg="blue",fg="white", font=("Times", 12),width=25)
entry2= Entry(root, font=("Times", 12))
label3=Label(root, text="ENTER ITEM QUANTITY",bd="2",relief="ridge",bg="Blue",fg="white", font=("Times", 12),width=25)
entry3= Entry(root, font=("Times", 12))
label4=Label(root, text="ENTER ITEM CATEGORY",bd="2",relief="ridge",bg="blue",fg="white", font=("Times", 12),width=25)
